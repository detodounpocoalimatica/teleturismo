    ...
    <div class="col-10 offset-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4 mt-5">
      ...
      <div class="card">
        <div class="card-body">
          ...
          $data=$bd->obtenerSolicitudesDePrecompraViajes();
          ...
          for ($cont=0;$cont<count($data);$cont++)
          {
            ...
            echo "Producto viaje: ".$bd->obtenerProductoViajePorID($data[$cont]['id_producto_viaje'])['nombre']."<br>";
          ...
          <form action="solicitudes_de_precompra_viajes.php" method="post">
