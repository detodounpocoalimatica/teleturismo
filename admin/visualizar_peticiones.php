    ...
    <div class="col-10 offset-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4 mt-5">
      ...
      <div class="card">
        <div class="card-body">
          ...
          $data=$bd->obtenerSolicitudesDeInformacion();
          ...
          for ($cont=0;$cont<count($data);$cont++)
          {
            ...
            echo "Email / Usuario: ".$data[$cont]['email']."<br>";
            ...
            echo "Información solicitada: ".$data[$cont]['consulta_de_informacion']."<br>";
          ...
          <form action="visualizar_peticiones.php" method="post">
