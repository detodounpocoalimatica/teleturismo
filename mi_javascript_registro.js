$(function()
{
	$("#registro").submit(function(event)
	{
		...
		else if (validar_telefono(telefono)==3 || validar_telefono(telefono)==4)
		{
			event.preventDefault();
			alert("El teléfonfo debería tener exactamente 9 digitos y además debe eliminar las letras");
		}		
